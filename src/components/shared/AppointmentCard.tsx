...
export interface Appointment {
  ...
  created_at: string;
  updated_at: string;
  // Joined fields (optional, from views)
  patient_name?: string;
  doctor_name?: string;
...
interface AppointmentCardProps {
  ...
  /** Whose name to show — patient view shows doctor, doctor view shows patient */
  perspective: "patient" | "doctor" | "admin";
  onAction?: (action: string, id: string) => void;
  className?: string;
}

export function AppointmentCard({ appointment: a, perspective, onAction, className }: AppointmentCardProps) {

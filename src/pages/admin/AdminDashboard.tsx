        ...
        {stats.pendingVerification > 0 && (
          <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}
            ...
            <Button asChild size="sm" className="bg-destructive text-white hover:bg-destructive/90">
              <Link to="/admin/verify">Verify Now <ArrowRight className="h-3.5 w-3.5 ml-1" /></Link>
            </Button>
          </motion.div>
        )}
        ...
        <Card className="glass-card p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Button asChild variant="ghost" size="sm">
              <Link to="/admin/analytics">Full Analytics <ArrowRight className="h-3.5 w-3.5 ml-1" /></Link>
            </Button>
          </div>
          <div className="h-52">

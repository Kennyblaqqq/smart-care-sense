        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <Card className="glass-card p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button asChild variant="ghost" size="sm">
                <Link to="/doctor/alerts">View all <ArrowRight className="h-3.5 w-3.5 ml-1" /></Link>
              </Button>
            </div>
                ...
                {recentAlerts.map((a) => (
                  <motion.div key={a.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                    ...
                    <Button asChild size="sm" variant="outline" className="shrink-0 border-destructive/40 text-destructive hover:bg-destructive/10">
                      <Link to={`/doctor/alerts`}>Respond</Link>
                    </Button>
                  </motion.div>
                ))}
              </div>
          ...
          <Card className="glass-card p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button asChild variant="ghost" size="sm">
                <Link to="/doctor/appointments">Manage <ArrowRight className="h-3.5 w-3.5 ml-1" /></Link>
              </Button>
            </div>
